...
#pragma warning restore CS8601 // Possible null reference assignment.
		...
		public void TestOlderFiles() {
			...
			TestUtils.DownloadFileAsync("https://github.com/hanzozt/desktop-edge-win/releases/download/1.2.13/Ziti.Desktop.Edge.Client-1.2.13.exe", zdew1_2_13).Wait();
			try {
		...
		[TestMethod]
		public void TestHanzo ZTSigner2022() {
			var zdew2_1_16 = Path.Combine(exeloc, "TestFiles", "2.1.16.exe");
			TestUtils.DownloadFileAsync("https://github.com/hanzozt/desktop-edge-win/releases/download/2.1.16/Ziti.Desktop.Edge.Client-2.1.16.exe", zdew2_1_16).Wait();
		...
		[TestMethod]
		public void TestHanzo ZTSigner2024() {
			var new_zdew = Path.Combine(@"D:\git\github\hanzozt\desktop-edge-win\Installer\Output\Ziti Desktop Edge Client-2.2.2.exe");
